...
@section('content')
    <div class="container product-box">
      <div class="row">
          <div class="col-md-5">
              <img class="detail-img img-fluid" src="https://cdn.webshopapp.com/shops/87334/files/373503110/image.jpg" alt="">
          </div>
          <div class="col-md-1"></div>

          <div class="col-md-5 detail-detail">
              <h1>Whey Protein</h1>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corrupti, veritatis voluptatum modi similique iusto in assumenda necessitatibus repellat perferendis exercitationem saepe iste dolor adipisci ducimus incidunt! Cum molestiae mollitia iusto.</p>
              <div class="price">
                 <h2>Price:</h2>
                  
                  <h3 class="mx-5">3000/-</h3>
              </div>
              <button class="button-52" role="button">Add to Cart</button>
          </div>
